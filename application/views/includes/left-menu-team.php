	...
	<div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse collapse">
	        <ul class="nav" id="side-menu">
	            <li>
	                <a href="<?php echo base_url().'team/profile/'.$this->uri->segment(3); ?>" class=" hvr-bounce-to-right"><i class="fa fa-dashboard nav_icon "></i><span class="nav-label">Tentang Team</span> </a>
	            </li>
				<li>
	                <a href="<?php echo base_url().'team/statistic/'.$this->uri->segment(3); ?>" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Statistik Team</span> </a>
	            </li>
	            <li>
	                <a href="<?php echo base_url().'team/history/'.$this->uri->segment(3); ?>" class=" hvr-bounce-to-right"><i class="fa fa-picture-o nav_icon"></i> <span class="nav-label">History Pertandingan</span> </a>
	            </li>
