...
<div class="container">
    ...
    <div class="p20" >
		<div class="cards-row">
		<?php if ($data_tipe_lapangan->num_rows() > 0) { ?>
        	<?php foreach ($data_tipe_lapangan->result() as $row) {?>
		        <div class="card-row">
		            <div class="card-row-inner">
		                <div class="card-row-image" style="background: url('<?php echo base_url().$row->picture ?>')center no-repeat;background-size: cover;">
			                ...
			                <div class="card-row-properties">
			                    ...
			                    <button class="btn btn-primary btn-block" type="submit"><i class="fa fa-hand-pointer-o"></i>Booking</button>
